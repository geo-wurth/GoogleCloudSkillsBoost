...
Command to create variables needed for this lab
    ...
    export INSTANCE1ID=<instance 1 id>
    export INSTANCE2ID=<instance 2 id>
    export INSTANCE3ID=<instance 3 id>
...
Copy and paste the following to the end of _main.tf_ file, fill in _Version Number_ and _Network Name_ instructed in the challenge:
    ...
    module "vpc" {
        ...
        projectid   = "qwiklabs-gcp-04-f2c1c01a09d3"
...
Add the following resource to the _main.tf_ file, fill in the _GCP Project ID_ and _Network Name_:
    ...
    resource "google_compute_firewall" "tf-firewall" {
        name    = "tf-firewall"
        network = "projects/<FILL IN PROJECTID>/global/networks/<FILL IN NETWORK NAME>"
